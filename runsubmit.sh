...
./lalinference_mcmc_submit_new.py --inj /projects/b1011/spinning_runs/STT4injections.xml --event 11 --approx SpinTaylorT4 --lowM1 1.0 --lowM2 5.0 --dir "Path to submit directory" 
